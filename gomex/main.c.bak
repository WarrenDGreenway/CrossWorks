...
u8 taskVoltage( void )
{
    ...
    print( COM3, "\r\rTime: %t", timeGet() );
    print( COM3, "\r\rVoltage: %f", voltage );
    print( COM3, "\rCurrent: %f", current );//voltage, current );
    print( COM3, "\rRawVoltage: %d\rRawCurrent: %d", rawVoltage, rawCurrent );
